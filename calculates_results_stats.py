...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic['pct_correct_breed'] = len(results_dic)
    ...
    for key in results_dic:
        ...
        if results_dic[key][2] == 1:
            ...
            # This happens when the pet image label indicates the image is-a-dog AND
        ...
        # Pet Image Label is not a Dog - counts number of not dog images
            ...
            # counts number of incorrect dog classifications
            if results_dic[key][4] == 1:
